  ...
  return (
    <ThemeProvider>
      <Flex w="100%" height="100vh" bg={{ base: 'whiteAlpha.100', _dark: 'whiteAlpha.200' }} fontFamily="Inter" p="3">
        <Stack w="100%" h="100%">
          <Flex pt="2" color={{ base: 'orange.600', _dark: 'orange.200' }}>
            ...
            <HStack alignItems="center" ml="auto">
              ...
              <styled.a target="blank" href="https://github.com/astahmer/lightningcss-ast-viewver">
                <IconButton title="Github" css={{ color: { base: 'orange.600', _dark: 'orange.200' } }}>
                  <GithubIcon />
                </IconButton>
              </styled.a>
              <styled.a target="blank" href="https://lightningcss.dev/">
                <IconButton title="LightningCSS" css={{ color: { base: 'orange.600', _dark: 'orange.200' } }}>
                  ⚡
                </IconButton>
              </styled.a>
              <ColorModeSwitch />
